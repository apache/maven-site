...
The Apache Maven team would like to announce the release of Maven 3.9.16.

Maven 3.9.16 is [available for download][0].
...
- the reference documentation: [https://maven.apache.org/ref/3.9.16/](/ref/3.9.16/)

## Overview About the Changes

Regression fixes and other improvements from Maven 3.9.15. All users already on Maven 3.9.x are advised to upgrade.

### Notable Changes in Maven 3.9.16

- Fix plugin prefix resolution - do not always force metadata download
- Allow the argument to `--threads` to be surrounded by spaces

## Full changelog

For a full list of changes, please refer to the [GitHub release page](https://github.com/apache/maven/releases/tag/maven-3.9.16).
