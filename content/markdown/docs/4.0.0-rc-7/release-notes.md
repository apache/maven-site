...
- Keep the basedir unset for a parent served from the project-local repository ([#13212](https://github.com/apache/maven/pull/13212)) @slachiewicz
...
- Bump jlineVersion from 4.4.3 to 4.4.5 ([#13220](https://github.com/apache/maven/pull/13220)) @[dependabot[bot]](https://github.com/apps/dependabot)
- Bump domtripVersion from 1.6.0 to 1.7.0 ([#13221](https://github.com/apache/maven/pull/13221)) @[dependabot[bot]](https://github.com/apps/dependabot)
