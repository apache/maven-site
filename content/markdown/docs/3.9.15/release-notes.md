...
The Apache Maven team would like to announce the release of Maven 3.9.15.

Maven 3.9.15 is [available for download][0].
...
- the reference documentation: [https://maven.apache.org/ref/3.9.15/](/ref/3.9.15/)

## Overview About the Changes

Regression fixes and other improvements from Maven 3.9.14. All users already on Maven 3.9.x are advised to upgrade.

### Notable Changes in Maven 3.9.15

- get rid of CVE from plexus-utils (by upgrading to 3.6.1)
- make Maven color console output work on Java 26+ (by upgrading to jansi 2.4.3)

## Full changelog

For a full list of changes, please refer to the [GitHub release page](https://github.com/apache/maven/releases/tag/maven-3.9.15).
