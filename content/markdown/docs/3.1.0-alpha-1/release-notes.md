...
The Apache Maven team would like to announce the release of Maven 3.1.0-alpha-1.

Maven 3.1.0-alpha-1 is [available for download](../../download.html).
...
- the reference documentation: [http://maven.apache.org/ref/3.1.0-alpha-1/](http://maven.apache.org/ref/3.1.0-alpha-1/)

## Issue Summary

[https://issues.apache.org/jira/secure/ReleaseNote.jspa?projectId=12316922&amp;version=12330182](https://issues.apache.org/jira/secure/ReleaseNote.jspa?projectId=12316922&version=12330182)
