...
# Release Notes &#x2013; Maven 3.9.4

The Apache Maven team would like to announce the release of Maven 3.9.4.

Maven 3.9.4 is [available for download][0].
...
- the reference documentation: [https://maven.apache.org/ref/3.9.4/](/ref/3.9.4/)
