...
# Maven 3.9.14 Release Notes

The Apache Maven team would like to announce the release of Maven 3.9.14.

Maven 3.9.14 is [available for download][0].
...
- the reference documentation: [https://maven.apache.org/ref/3.9.14/](/ref/3.9.14/)

## Overview About the Changes

Fixing one known issue from Maven 3.9.13. All users already on Maven 3.9.x are advised to upgrade.

### Notable Changes in Maven 3.9.14

Release 3.9.14 is a "quickfix" to alleviate the [one known issue](https://github.com/apache/maven/issues/11762) from 3.9.13.

## Full changelog

For a full list of changes, please refer to the [GitHub release page](https://github.com/apache/maven/releases/tag/maven-3.9.14).
