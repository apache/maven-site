...
- you have JDK installed and on your shell's path to build Maven 3.9.0+. Details about minimum JDK version to build can be found here: [https://maven.apache.org/docs/history.html](/docs/history.html)
...
- check existing issues with _Blocker_ priority. Consider fixing or changing the priority
